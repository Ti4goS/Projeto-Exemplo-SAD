...
INSERT INTO TB_TIPO_PAGAMENTO VALUES (04, 'FIADO')
...
-- ATV 04
INSERT INTO TB_CIDADE VALUES (0010, 'ITABAIANA', 09)

INSERT INTO TB_TIPO_PAGAMENTO VALUES (04, 'FIADO')

INSERT INTO TB_LOJA VALUES (005, 'CHICO DA MANSINHA', 0010)

INSERT INTO TB_PRODUTO (COD_PRODUTO, PRODUTO, COD_CATEGORIA, VALOR)
VALUES (7, 'DIESEL S-10', 3, 6.30)

INSERT INTO TB_VENDA (COD_LOJA, COD_PRODUTO, COD_TIPO_PAGAMENTO, DATA_VENDA, VOLUME, VALOR)
VALUES (001, 7, 01, GETDATE(), 100, 5000.00)

INSERT INTO TB_VENDA (COD_LOJA, COD_PRODUTO, COD_TIPO_PAGAMENTO, DATA_VENDA, VOLUME, VALOR)
VALUES (005, 1, 01, GETDATE(), 100, 5000.00)

INSERT INTO TB_VENDA (COD_LOJA, COD_PRODUTO, COD_TIPO_PAGAMENTO, DATA_VENDA, VOLUME, VALOR)
VALUES (001, 1, 04, GETDATE(), 100, 5000.00)

INSERT INTO TB_VENDA (COD_LOJA, COD_PRODUTO, COD_TIPO_PAGAMENTO, DATA_VENDA, VOLUME, VALOR)
VALUES (001, 1, 01, GETDATE(), 100, 5000.00)

INSERT INTO TB_VENDA (COD_LOJA, COD_PRODUTO, COD_TIPO_PAGAMENTO, DATA_VENDA, VOLUME, VALOR)
VALUES (005, 7, 04, GETDATE(), 100, 5000.00)

INSERT INTO TB_VENDA (COD_LOJA, COD_PRODUTO, COD_TIPO_PAGAMENTO, DATA_VENDA, VOLUME, VALOR)
VALUES (005, 7, 04, '20240101', 100, 5000.00)